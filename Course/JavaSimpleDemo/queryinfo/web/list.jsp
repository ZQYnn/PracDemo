...
<div class="container">
    ...
    <div style="float: left">
        <form class="form-inline" action="findConditionServlet" method="post">
    ...
    <form id="form" action="delSelectedServlet" method="post">
        ...
        <c:forEach items="${users}" var="user" varStatus="s">
            <tr>
                ...
                <td>${user.qq}</td>
                <td>${user.email}</td>
                <td><a class="btn btn-default btn-sm " href="findUserByIdServlet?id=${user.id}">修改</a>&nbsp;
                    <a class="btn btn-default btn-sm" href= "javascript:deleteusers(${user.id})"> 删除</a></td>
